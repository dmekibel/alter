...
- **The border rule (the grove collision, resolved):** forever-recurring with no finish line = tree only. Bounded with a finish line = statue, which may LINK trees but never replaces them. A practice-shaped goal ("meditate daily forever") gets routed to the grove with one direct line, no riddle: "This one sounds like a practice. Practices live in the grove. Plant it there?" (the original negation-contrast phrasing FAILED copy-audit 2026-08-13; this is the shipped line)
