...
- **ONE move, David:** answer OQ1-3 in the spec (arc color / peek scope / commit copy) + pick H-D1 vs B1 first.
- **ONE move, Claude (next Opus session):** build H-D1 from the spec, one shot, ship.
